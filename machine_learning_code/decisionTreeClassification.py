""" Feature Scaling using StandardScaler is a must-do when Euclidean distance is involved in the algorithm 
and if not feature scaling can be skipped"""
...
plotter.title('Decision Tree Classification (Training Dataset)')
plotter.xlabel('Age')
